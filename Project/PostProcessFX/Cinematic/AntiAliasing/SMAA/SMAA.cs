...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class SMAA : IAntiAliasing
    {
        ...
        public Shader shader
        {
            ...
            {
                if (m_Shader == null)
                    m_Shader = PPFXUtility.checkAndLoadAsset<Shader>(ModDescription.loadedBundle, "Smaa.shader");
        ...
        private Texture2D areaTexture
        {
            get
            {
                if (m_AreaTexture == null)
                    m_AreaTexture = PPFXUtility.checkAndLoadAsset<Texture2D>(ModDescription.loadedBundle, "AreaTex.tga");
        ...
        private Texture2D searchTexture
        {
            get
            {
                if (m_SearchTexture == null)
                    m_SearchTexture = PPFXUtility.checkAndLoadAsset<Texture2D>(ModDescription.loadedBundle, "SearchTex.tga");
