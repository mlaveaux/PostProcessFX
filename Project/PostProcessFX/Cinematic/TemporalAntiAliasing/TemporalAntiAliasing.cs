...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class CineTemporalAntiAliasing : MonoBehaviour
    {
        ...
        public Shader shader
        {
            ...
            {
                if (m_Shader == null)
                    m_Shader = PPFXUtility.checkAndLoadAsset<Shader>(ModDescription.loadedBundle, "TemporalAntiAliasing.shader");
